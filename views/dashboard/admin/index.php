...
<div class="row g-3 mb-5">
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card border-0 shadow-sm text-center p-3">
            ...
            <h2 class="h3 fw-bold"><?= $totalUsers ?></h2>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card border-0 shadow-sm text-center p-3">
            <i class="bi bi-car-front fs-1 text-warning mb-2"></i>
            <h2 class="h3 fw-bold"><?= $totalVehicles ?></h2>
            <p class="text-muted mb-0 small">Véhicules</p>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card border-0 shadow-sm text-center p-3">
            ...
            <h2 class="h3 fw-bold"><?= $ongoing ?></h2>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card border-0 shadow-sm text-center p-3">
            <i class="bi bi-check-circle fs-1 text-dark mb-2"></i>
            <h2 class="h3 fw-bold"><?= $done ?></h2>
            <p class="text-muted mb-0 small">Terminées</p>
        </div>
    </div>

    <div class="col-12">
        <div class="card border-0 shadow-sm bg-dark text-white text-center p-4">
            <p class="text-secondary mb-1 small">Chiffre d'affaires théorique (hors annulées)</p>
...
<!-- Raccourcis -->
<h2 class="h5 fw-bold mb-3">Gestion de la plateforme</h2>
<div class="row g-3">

    <div class="col-md-4">
        <a href="<?= APP_URL ?>/dashboard/admin/users"
           class="card border-0 shadow-sm text-decoration-none text-dark h-100 p-4 d-flex flex-row align-items-center gap-3">
        ...
        <a href="<?= APP_URL ?>/dashboard/admin/categories"
           class="card border-0 shadow-sm text-decoration-none text-dark h-100 p-4 d-flex flex-row align-items-center gap-3">
            ...
            <div>
                ...
                <small class="text-muted">Ajouter de nouvelles catégories</small>
            </div>
        </a>
    </div>
